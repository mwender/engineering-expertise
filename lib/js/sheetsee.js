...
module.exports.initiateTableFilter = function(opts) {
  $('.clear').on("click", function() {
    ...
    makeTable(opts)
    searchTable(opts, '') // forces a rebuild of all heading rows
  })
...
function searchTable(opts, searchTerm) {
  currentCategory = ''; // set global var to empty so that heading rows gets built
  var filteredList = []
...
function makeTable(opts, filteredList) {
  ...
  // Hide items when building table - MWENDER
